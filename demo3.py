...
window = Window(width=800, height=600, caption='Demo3: A Room', resizable=True)
...
def update(dt):
    ...
    window.render(Wall((2.0, 0.5), (2.0, 2.0), 1.5, 'Textures/brick.jpg'))
    window.render(Wall((2.0, 2.0), (-1.0, 2.0), 1.5, 'Textures/brick.jpg'))
    window.render(Wall((-1.0, 2.0), (-1.0, 0.0), 1.5, 'Textures/brick.jpg'))

    window.render(Layer((-1.0, 0.0), (2.0, 0.0), (2.0, 2.0), (-1.0, 2.0), 1.5, 'Textures/metal.jpg'))
    window.render(Layer((-1.0, 0.0), (2.0, 0.0), (2.0, 2.0), (-1.0, 2.0), 0, 'Textures/wood.jpg'))
